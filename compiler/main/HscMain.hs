...
checkSafeImports dflags tcg_env
  ...
  where
    ...
    pkgTrustReqs :: Set UnitId -> Set UnitId -> Bool -> ImportAvails
...
hscCheckSafe' :: DynFlags -> Module -> SrcSpan -> Hsc (Maybe UnitId, Set UnitId)
...
checkPkgTrust :: DynFlags -> Set UnitId -> Hsc ()
